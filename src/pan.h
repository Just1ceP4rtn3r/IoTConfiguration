...
struct PersonalData { /* user defined type */
	unsigned isEmpty : 1;
	unsigned shared : 1;
	short userId;
};
struct History { /* user defined type */
	unsigned isEmpty : 1;
	unsigned shared : 1;
	short userId;
};
...
struct Subject { /* user defined type */
	short id;
};
struct Right { /* user defined type */
	short id;
};
struct Policy { /* user defined type */
	unsigned banned : 1;
	short id;
